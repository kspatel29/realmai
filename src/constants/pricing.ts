...
export const SERVICE_CREDIT_COSTS = {
  DUBBING: {
    BASE_CREDITS_PER_MINUTE: Math.ceil(SERVICE_PRICING.DUBBING.BASE_PRICE_PER_MINUTE * CREDIT_CONVERSION_RATE),
    LIPSYNC_CREDITS_PER_MINUTE: Math.ceil(SERVICE_PRICING.DUBBING.LIPSYNC_PRICE_PER_MINUTE * CREDIT_CONVERSION_RATE)
  },
  SUBTITLES: {
    BASE_CREDITS: Math.ceil(SERVICE_PRICING.SUBTITLES.PRICE_PER_RUN * CREDIT_CONVERSION_RATE),
    PREMIUM_CREDITS: Math.ceil(SERVICE_PRICING.SUBTITLES.PRICE_PER_RUN * CREDIT_CONVERSION_RATE * 1.5)
  },
  VIDEO_GENERATION: {
    CREDITS_PER_SECOND: Math.ceil(SERVICE_PRICING.VIDEO_GENERATION.PRICE_PER_SECOND * CREDIT_CONVERSION_RATE)
  }
};
